...
class ERA5WavePeriodDataLoader(ScalarDataLoader):  # type: ignore[misc]
    def import_data(self, bounds: Boundary) -> xr.Dataset:
        ...
        Returns:
            xr.Dataset:
                ...
                Dataset has coordinates 'lat', 'long', and variable 'mwp'
        """
        time_range = [
        ...
        if self.files is None:
            raise ValueError("files parameter is required for ERA5WavePeriodDataLoader")
        self.files: list[str] = [
            file
