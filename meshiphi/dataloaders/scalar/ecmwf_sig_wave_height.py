...
class ECMWFSigWaveHeightDataLoader(ScalarDataLoader):
    def import_data(self, bounds):
        ...
        def calculate_timestamp(filename):
            ...
            # Calculate
            return datetime.strptime(base_date, "%Y%m%d%H0000") + timedelta(hours=forecast_len)
        ...
        self.files = [file for file in self.files if extract_base_date(file) == closest_date]
