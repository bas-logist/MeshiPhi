...
defined in the `get_dataloader()` method of the factory. At the very
...
is located at `meshiphi.Dataloaders/Scalar/myScalarDataloader.py`.
...
To call this dataloader, add an entry in the `config.json` 
